  ...
  <div class="content-wrapper text-sm">
    ...
    <section class="content">
      ...
      if($gambar==''){
        ...
        $path_foto = base_url('file/kavling_cluster/gambar/'.$gambar);
      }
      ?>
          ...
          <div class="col-12">
            <div class="card pt-3 pl-3 pr-3 pb-3">
              <div class="row">
                  ...
                  <div class="card card-default color-palette-box">
                    <div class="card-header">
                      <h3 class="card-title">
                        ...
                        Foto Kavling Cluster
                      </h3>
                    </div>
                    <div class="card-body pb-2">
                      <div class="form-group">
                        <img src="<?php echo $path_foto; ?>" alt="Logo Kavling Cluster" style="width: 100%; border-radius: 10px">
                ...
                if ($dt['u']!=0) {
                ?>
                    <form action="<?php echo site_url('MasterKavlingCluster/proses_foto'); ?>" method="post" enctype="multipart/form-data">
                      <input type="hidden" id="kode_kc" name="kode_kc" value="<?php echo($kode_kc); ?>">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label form-control-sm">Foto</label>
                        <div class="col-sm-9 form-group">
                          <input type="file" class="form-control-file form-control-sm" id="gambar" name="gambar" accept="image/*" placeholder="File Foto Kavling Cluster">
                        </div>
                      </div>
                ...
                <div class="col-12 text-center">
                  <a href="<?php echo site_url('MasterKavlingCluster') ?>" class="btn bg-gradient-secondary"><i class="fas fa-arrow-left"></i>&ensp;Kembali</a>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
